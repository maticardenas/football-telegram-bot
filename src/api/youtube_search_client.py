...
class YoutubeSearchClient:
    def __init__(self) -> None:
        super().__init__()
        self.base_url = f"https://{NotifConfig.X_YOUTUBE_SEARCH_HOST}/get_keywords_video/v1"
        self.headers = {
    ...
    def search_videos_by_keywords(self, query: List[str], language: str, region: str) -> Dict[str, Any]:
